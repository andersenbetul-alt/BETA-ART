#!/bin/sh
# Vercel build tarifi — vercel.json'daki buildCommand 256 karakter şema
# sınırını aştığı için (550 karakter) buraya taşındı. Davranış birebir aynı:
# BETA-ART deposunu klonla, gereken dosyaları dist/'e kopyala.
set -e
