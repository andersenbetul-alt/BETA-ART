...
const META = {
  en: ['HXI — Norwegian Phonk Producer', 'Norwegian phonk producer from Oslo. 43M+ Spotify streams. Drift phonk, phonk house, montagem.'],
  zh: ['HXI — 挪威 Phonk 制作人', '来自奥斯陆的挪威 phonk 制作人，Spotify 播放量超过 4300 万。Drift phonk、phonk house、montagem。'],
  hi: ['HXI — नॉर्वेजियन फोंक प्रोड्यूसर', 'ओस्लो के नॉर्वेजियन फोंक प्रोड्यूसर। 4.3 करोड़+ स्पॉटिफ़ाई स्ट्रीम। ड्रिफ्ट फोंक, फोंक हाउस, मोंटाजेम।'],
  es: ['HXI — Productor noruego de phonk', 'Productor noruego de phonk desde Oslo. Más de 43 M de reproducciones en Spotify. Drift phonk, phonk house, montagem.'],
  ar: ['HXI — منتج فونك نرويجي', 'منتج فونك نرويجي من أوسلو. أكثر من 43 مليون استماع على سبوتيفاي. دريفت فونك، فونك هاوس، مونتاجيم.'],
  fr: ['HXI — Producteur de phonk norvégien', 'Producteur de phonk norvégien basé à Oslo. Plus de 43 M d’écoutes sur Spotify. Drift phonk, phonk house, montagem.'],
  bn: ['HXI — নরওয়েজিয়ান ফোংক প্রযোজক', 'অসলোর নরওয়েজিয়ান ফোংক প্রযোজক। ৪.৩ কোটির বেশি স্পটিফাই স্ট্রিম। ড্রিফট ফোংক, ফোংক হাউস, montagem।'],
  pt: ['HXI — Produtor norueguês de phonk', 'Produtor norueguês de phonk, de Oslo. Mais de 43 mi de streams no Spotify. Drift phonk, phonk house, montagem.'],
  ru: ['HXI — норвежский фонк-продюсер', 'Норвежский фонк-продюсер из Осло. Более 43 млн прослушиваний в Spotify. Дрифт-фонк, фонк-хаус, montagem.'],
  ur: ['HXI — نارویجن فونک پروڈیوسر', 'اوسلو سے نارویجن فونک پروڈیوسر۔ اسپاٹیفائی پر 4.3 کروڑ سے زائد اسٹریمز۔ ڈرفٹ فونک، فونک ہاؤس، montagem۔'],
  no: ['HXI — norsk phonk-produsent', 'Norsk phonk-produsent fra Oslo. Over 43 millioner strømminger på Spotify. Drift phonk, phonk house, montagem.'],
  tr: ['HXI — Norveçli phonk prodüktörü', 'Oslo’dan Norveçli phonk prodüktörü. 43 milyondan fazla Spotify dinlenmesi. Drift phonk, phonk house, montagem.'],
};
