...
6. **Sayfa iskeleti sekiz dosyada tekrar eder.** Menü veya altbilgiyi değiştirirken
   hepsini birden güncelleyin (`index`, `work`, `blog`, `post`, `gizlilik`, `kosullar`, `kalite`, `ornek`).
   `check.mjs` çiftlenen id ve script'leri yakalar ama eksik menü bağlantısını yakalamaz.
