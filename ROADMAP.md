...
| 2 | Alan adı bağla ve yayına al | *Sürüyor* | qblogg.com başkasında; **qblogg.no** seçildi. Site tüm dosyalarda qblogg.no'ya çevrildi. Kalan: .no kaydı (Norid bayisi, Norveç kimlik/org.nr şart) + DNS |
