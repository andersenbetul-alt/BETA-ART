...
window.PP_SPRAK = (function () {
  ...
  var OPPGAVENAVN = {
    ...
    samvaer: { nb:'Sosialt besøk',sv:'Socialt besök',da:'Socialt besøg',en:'Social visit',de:'Besuch und Gespräch',nl:'Sociaal bezoek',fr:'Visite et conversation',es:'Visita y conversación',it:'Visita e compagnia',pt:'Visita e companhia',pl:'Wizyta towarzyska',ru:'Общение',tr:'Sosyal ziyaret',ar:'زيارة اجتماعية',ur:'ملاقات اور گفتگو',so:'Booqasho bulsheed',vi:'Thăm hỏi trò chuyện',zh:'陪伴探访' },
    tur: { nb:'Tur og aktivitet',sv:'Promenad och aktivitet',da:'Gåtur og aktivitet',en:'Walk and activity',de:'Spaziergang und Aktivität',nl:'Wandeling en activiteit',fr:'Promenade et activité',es:'Paseo y actividad',it:'Passeggiata e attività',pt:'Passeio e atividade',pl:'Spacer i aktywność',ru:'Прогулка и занятия',tr:'Yürüyüş ve etkinlik',ar:'نزهة ونشاط',ur:'سیر اور سرگرمی',so:'Socod iyo hawlo',vi:'Đi dạo và hoạt động',zh:'散步与活动' },
    digital: { nb:'Hjelp med telefon og TV',sv:'Hjälp med telefon och TV',da:'Hjælp med telefon og TV',en:'Phone and TV help',de:'Hilfe mit Telefon und TV',nl:'Hulp met telefoon en tv',fr:'Aide téléphone et télévision',es:'Ayuda con teléfono y TV',it:'Aiuto con telefono e TV',pt:'Ajuda com telefone e TV',pl:'Pomoc z telefonem i TV',ru:'Помощь с телефоном и ТВ',tr:'Telefon ve TV yardımı',ar:'مساعدة في الهاتف والتلفاز',ur:'فون اور ٹی وی میں مدد',so:'Caawimaad taleefan iyo TV',vi:'Hỗ trợ điện thoại và TV',zh:'手机与电视协助' },
    praktisk: { nb:'Små praktiske oppgaver',sv:'Små praktiska sysslor',da:'Små praktiske opgaver',en:'Small practical tasks',de:'Kleine praktische Aufgaben',nl:'Kleine praktische klusjes',fr:'Petites tâches pratiques',es:'Pequeñas tareas prácticas',it:'Piccole faccende pratiche',pt:'Pequenas tarefas práticas',pl:'Drobne prace praktyczne',ru:'Мелкие бытовые дела',tr:'Küçük pratik işler',ar:'مهام عملية صغيرة',ur:'چھوٹے عملی کام',so:'Hawlo yaryar oo wax ku ool ah',vi:'Việc vặt thực tế',zh:'小型实务' },
    hjemme: { nb:'Lett husarbeid',sv:'Lätt hushållsarbete',da:'Let husarbejde',en:'Light housework',de:'Leichte Hausarbeit',nl:'Licht huishoudelijk werk',fr:'Travaux ménagers légers',es:'Tareas domésticas ligeras',it:'Lavori domestici leggeri',pt:'Trabalho doméstico leve',pl:'Lekkie prace domowe',ru:'Лёгкая работа по дому',tr:'Hafif ev işleri',ar:'أعمال منزلية خفيفة',ur:'ہلکے گھریلو کام',so:'Shaqo guri fudud',vi:'Việc nhà nhẹ',zh:'轻家务' },
    mat: { nb:'Matlaging',sv:'Matlagning',da:'Madlavning',en:'Cooking',de:'Kochen',nl:'Koken',fr:'Préparation des repas',es:'Preparación de comidas',it:'Preparazione dei pasti',pt:'Preparação de refeições',pl:'Gotowanie',ru:'Приготовление еды',tr:'Yemek hazırlama',ar:'إعداد الطعام',ur:'کھانا تیار کرنا',so:'Karinta cuntada',vi:'Nấu ăn',zh:'做饭' },
    folge: { nb:'Følge til avtale',sv:'Följe till möte',da:'Ledsagelse til aftale',en:'Accompaniment to appointment',de:'Begleitung zum Termin',nl:'Begeleiding naar afspraak',fr:'Accompagnement à un rendez-vous',es:'Acompañamiento a la cita',it:'Accompagnamento agli appuntamenti',pt:'Acompanhamento a consultas',pl:'Towarzyszenie na wizytę',ru:'Сопровождение на приём',tr:'Randevuya eşlik',ar:'المرافقة إلى الموعد',ur:'ملاقات پر ہمراہی',so:'Raacid ballan',vi:'Đi cùng đến hẹn',zh:'陪同赴约' }
  };
