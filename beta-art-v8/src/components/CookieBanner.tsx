...
export default function CookieBanner() {
  ...
  return (
    <div
      ...
      style={{ background: '#0F0F0F', borderTop: '1px solid #2C2C2C' }}
      role="alertdialog"
      aria-live="polite"
      ...
      <div className="max-w-7xl mx-auto px-6 py-5 sm:px-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              Dette nettstedet bruker informasjonskapsler for å analysere trafikk og forbedre opplevelsen.
              {' '}
              <span style={{ color: '#FBFAF7' }}>
                Ingen data selges til tredjeparter.
              </span>
              {' '}
              Du kan trekke tilbake samtykket når som helst via personverninnstillingene.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <button
              ...
              className="whitespace-nowrap text-sm px-4 py-2 transition-colors"
              style={{
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.color = '#FBFAF7'; }}
            ...
            <button
              ...
              autoFocus
              className="whitespace-nowrap text-sm px-5 py-2 transition-colors"
              style={{
                fontFamily: "'Inter', sans-serif",
                background: '#FBFAF7',
                color: '#0F0F0F',
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.background = '#E8E6E0'; }}
              onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.background = '#FBFAF7'; }}
            >
              Godta
            </button>
          </div>
