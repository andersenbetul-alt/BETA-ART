...
(ilk sürüm 22.08.2026'daydı; i18n anahtar/CSS satır/ikon/sayfa sayıları o
tarihten bu yana değiştiği için yeniden ölçülüp güncellendi).
...
Yerine geçen şey: `assets/css/main.css` içinde **~100 sınıf**, sekiz HTML
