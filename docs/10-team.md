...
Counted from the repo at the time of writing: 91 pages, 26 Norwegian pages,
9 tooling scripts, 5 automated gates, 8 documents, 26 commits, 6 pages with a
...
| 5 | UX Designer | Site architecture, the 20-point structure, the guided quote flow, the finder | **Done.** 91 pages with a real information architecture |
...
| 8 | Copywriter / UX Writer | Every word on 91 pages, in English and Norwegian | **Done.** Norwegian is written, not translated |
...
| 16 | QA / Test Engineer | Testing on real devices | **Automated part done** — five gates, one of which opens every page in a real browser at three widths. The human part, on real phones, is not done |
...
other nineteen. Every claim on 91 pages is currently a hypothesis written
