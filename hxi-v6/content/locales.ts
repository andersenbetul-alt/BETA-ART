...
export type LocaleData = {
  ...
  syncPage: {
    ...
    lead: string;
    worksH: string;
    works: Array<{ t: string; meta: string; c: string }>;
    fieldsH: string;
    fields: string[];
    emailCta: string;
    note: string;
...
export const localeData: Record<Locale, LocaleData> = {
  en: {
    ...
    usePage: {
      title: 'Use HXI Music — Creator / NCS Information',
      description: 'How to use HXI music in your content: NCS releases and track-specific terms.',
      eyebrow: 'CREATOR USE',
      heading: 'Use HXI music.',
      lead: 'Quick answer: some HXI tracks are cleared for creator content. Terms are track-specific.',
      noteH: 'IMPORTANT',
      note: 'Terms are track-specific. NCS releases follow NCS terms. Other tracks have separate terms. Do not assume blanket permission — check the track before publishing.',
      ncsH: 'NCS releases',
      ncsP: 'Tracks released through NCS can be used in YouTube videos, TikTok, streams and other online content under the current NCS terms.',
      checkTerms: 'Check track terms ↗',
      proH: 'Professional / commercial use',
      proP: 'Film, TV, advertising and game placements do not run under creator terms. Creator use is not licensing ownership — use the sync route.',
      syncCta: 'Sync / licensing →',
      navLabel: 'Creator use',
    },
    syncPage: {
      title: 'HXI Sync & Licensing',
      description: 'HXI music for film, TV, games and advertising. Professional sync and licensing inquiries.',
      eyebrow: 'SYNC / LICENSING',
      heading: 'Music for image.',
      lead: 'Direct contact, no intermediaries. For film, game, advertising and media use.',
      worksH: 'SYNC-RELEVANT WORKS',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: 'High energy, distorted phonk. Documented remix credit.' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: 'Controlled aggression, cinematic build.' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: 'Direct, fast, uncompromising.' }],
      fieldsH: 'Include in your inquiry',
      fields: ['Project type', 'Usage', 'Territory', 'Term', 'Budget range', 'Deadline', 'Contact'],
      emailCta: 'Send sync inquiry ↗',
      note: 'Terms are agreed case by case. No blanket rights claims — some works involve third-party rights holders.',
      navLabel: 'Sync',
    },
  },
  no: {
    ...
    usePage: {
      title: 'Bruk HXI-musikk — skaper / NCS-informasjon',
      description: 'Slik bruker du HXI-musikk i innholdet ditt: NCS-utgivelser og sporvise vilkår.',
      eyebrow: 'SKAPERBRUK',
      heading: 'Bruk HXI-musikk.',
      lead: 'Kort svar: noen HXI-spor er klarert for skaperinnhold. Vilkårene er sporvise.',
      noteH: 'VIKTIG',
      note: 'Vilkårene gjelder per spor. NCS-utgivelser følger NCS-vilkårene. Andre spor har egne vilkår. Ikke anta generell tillatelse — sjekk sporet før du publiserer.',
      ncsH: 'NCS-utgivelser',
      ncsP: 'Spor utgitt gjennom NCS kan brukes i YouTube-videoer, TikTok, strømmer og annet nettinnhold under gjeldende NCS-vilkår.',
      checkTerms: 'Sjekk sporvilkår ↗',
      proH: 'Profesjonell / kommersiell bruk',
      proP: 'Film, TV, reklame og spillplasseringer går ikke under skapervilkår. Skaperbruk er ikke lisensrettigheter — bruk sync-ruten.',
      syncCta: 'Sync / lisensiering →',
      navLabel: 'Skaperbruk',
    },
    syncPage: {
      title: 'HXI Sync og lisensiering',
      description: 'HXI-musikk for film, TV, spill og reklame. Profesjonelle sync- og lisensforespørsler.',
      eyebrow: 'SYNC / LISENSIERING',
      heading: 'Musikk for bilde.',
      lead: 'Direkte kontakt, ingen mellomledd. For film, spill, reklame og media.',
      worksH: 'SYNC-KLARE VERK',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: 'Høy energi, forvrengt phonk. Dokumentert remiks-kreditt.' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: 'Kontrollert aggresjon, filmatisk oppbygging.' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: 'Direkte, raskt, kompromissløst.' }],
      fieldsH: 'Ta med i forespørselen',
      fields: ['Prosjekttype', 'Bruk', 'Territorium', 'Varighet', 'Budsjettramme', 'Frist', 'Kontakt'],
      emailCta: 'Send sync-forespørsel ↗',
      note: 'Vilkår avtales fra sak til sak. Ingen generelle rettighetskrav — enkelte verk har tredjeparts rettighetshavere.',
      navLabel: 'Sync',
    },
  },
  tr: {
    ...
    usePage: {
      title: 'HXI Müziğini Kullan — Üretici / NCS Bilgisi',
      description: 'HXI müziğini içeriğinde nasıl kullanırsın: NCS yayınları ve parçaya özel koşullar.',
      eyebrow: 'ÜRETİCİ KULLANIMI',
      heading: 'HXI müziğini kullan.',
      lead: 'Kısa cevap: bazı HXI parçaları içerik üreticileri için açık. Koşullar parçaya özeldir.',
      noteH: 'ÖNEMLİ',
      note: 'Koşullar parçaya özeldir. NCS yayınları NCS koşullarına tabidir. Diğer parçaların koşulları ayrıdır. Genel izin varsayma — yayınlamadan önce parçayı kontrol et.',
      ncsH: 'NCS yayınları',
      ncsP: 'NCS üzerinden yayınlanan parçalar, güncel NCS koşulları altında YouTube, TikTok, yayın ve diğer çevrimiçi içeriklerde kullanılabilir.',
      checkTerms: 'Parça koşullarına bak ↗',
      proH: 'Profesyonel / ticari kullanım',
      proP: 'Film, TV, reklam ve oyun yerleşimleri üretici koşullarına girmez. Üretici kullanımı lisans sahipliği değildir — sync yolunu kullan.',
      syncCta: 'Sync / lisanslama →',
      navLabel: 'Üretici kullanımı',
    },
    syncPage: {
      title: 'HXI Sync ve Lisanslama',
      description: 'Film, TV, oyun ve reklam için HXI müziği. Profesyonel sync ve lisans talepleri.',
      eyebrow: 'SYNC / LİSANSLAMA',
      heading: 'Görüntü için müzik.',
      lead: 'Aracı yok, doğrudan iletişim. Film, oyun, reklam ve medya kullanımı için.',
      worksH: 'SYNC’E UYGUN İŞLER',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: 'Yüksek enerji, distorte phonk. Belgeli remix katkısı.' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: 'Kontrollü agresyon, sinematik yükseliş.' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: 'Doğrudan, hızlı, tavizsiz.' }],
      fieldsH: 'Talebine ekle',
      fields: ['Proje türü', 'Kullanım', 'Bölge', 'Süre', 'Bütçe aralığı', 'Termin', 'İletişim'],
      emailCta: 'Sync talebi gönder ↗',
      note: 'Koşullar duruma göre belirlenir. Genel hak iddiası yok — bazı işlerde üçüncü taraf hak sahipleri vardır.',
      navLabel: 'Sync',
    },
  },
  fr: {
    ...
    usePage: {
      title: 'Utiliser la musique HXI — créateurs / infos NCS',
      description: 'Comment utiliser la musique HXI dans vos contenus : sorties NCS et conditions par titre.',
      eyebrow: 'USAGE CRÉATEUR',
      heading: 'Utiliser la musique HXI.',
      lead: 'Réponse courte : certains titres HXI sont autorisés pour le contenu créateur. Les conditions dépendent du titre.',
      noteH: 'IMPORTANT',
      note: 'Les conditions sont propres à chaque titre. Les sorties NCS suivent les conditions NCS. Les autres titres ont des conditions distinctes. Ne présumez d’aucune autorisation générale — vérifiez le titre avant de publier.',
      ncsH: 'Sorties NCS',
      ncsP: 'Les titres sortis via NCS peuvent être utilisés dans des vidéos YouTube, TikTok, streams et autres contenus en ligne selon les conditions NCS en vigueur.',
      checkTerms: 'Voir les conditions du titre ↗',
      proH: 'Usage professionnel / commercial',
      proP: 'Film, TV, publicité et placements jeu ne relèvent pas des conditions créateur. L’usage créateur n’est pas une licence — passez par la voie sync.',
      syncCta: 'Sync / licences →',
      navLabel: 'Usage créateur',
    },
    syncPage: {
      title: 'HXI Sync et licences',
      description: 'La musique HXI pour le film, la TV, le jeu et la publicité. Demandes professionnelles de sync et de licence.',
      eyebrow: 'SYNC / LICENCES',
      heading: 'La musique pour l’image.',
      lead: 'Contact direct, sans intermédiaire. Pour le film, le jeu, la publicité et les médias.',
      worksH: 'ŒUVRES PRÊTES POUR LA SYNC',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: 'Haute énergie, phonk saturé. Crédit de remix documenté.' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: 'Agression contrôlée, montée cinématique.' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: 'Direct, rapide, sans compromis.' }],
      fieldsH: 'À inclure dans votre demande',
      fields: ['Type de projet', 'Usage', 'Territoire', 'Durée', 'Fourchette budgétaire', 'Échéance', 'Contact'],
      emailCta: 'Envoyer une demande sync ↗',
      note: 'Les conditions sont convenues au cas par cas. Aucune revendication générale de droits — certaines œuvres impliquent des ayants droit tiers.',
      navLabel: 'Sync',
    },
  },
  de: {
    ...
    usePage: {
      title: 'HXI-Musik nutzen — Creator / NCS-Infos',
      description: 'So nutzt du HXI-Musik in deinen Inhalten: NCS-Releases und trackspezifische Bedingungen.',
      eyebrow: 'CREATOR-NUTZUNG',
      heading: 'HXI-Musik nutzen.',
      lead: 'Kurze Antwort: einige HXI-Tracks sind für Creator-Inhalte freigegeben. Die Bedingungen gelten pro Track.',
      noteH: 'WICHTIG',
      note: 'Die Bedingungen gelten pro Track. NCS-Releases folgen den NCS-Bedingungen. Andere Tracks haben eigene Bedingungen. Keine Pauschalerlaubnis annehmen — prüfe den Track vor der Veröffentlichung.',
      ncsH: 'NCS-Releases',
      ncsP: 'Über NCS veröffentlichte Tracks können unter den aktuellen NCS-Bedingungen in YouTube-Videos, TikTok, Streams und anderen Online-Inhalten genutzt werden.',
      checkTerms: 'Track-Bedingungen prüfen ↗',
      proH: 'Professionelle / kommerzielle Nutzung',
      proP: 'Film, TV, Werbung und Game-Platzierungen fallen nicht unter Creator-Bedingungen. Creator-Nutzung ist keine Lizenz — nutze den Sync-Weg.',
      syncCta: 'Sync / Lizenzierung →',
      navLabel: 'Creator-Nutzung',
    },
    syncPage: {
      title: 'HXI Sync & Lizenzierung',
      description: 'HXI-Musik für Film, TV, Games und Werbung. Professionelle Sync- und Lizenzanfragen.',
      eyebrow: 'SYNC / LIZENZIERUNG',
      heading: 'Musik für das Bild.',
      lead: 'Direkter Kontakt, keine Zwischenhändler. Für Film, Game, Werbung und Medien.',
      worksH: 'SYNC-RELEVANTE ARBEITEN',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: 'Hohe Energie, verzerrter Phonk. Dokumentierter Remix-Credit.' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: 'Kontrollierte Aggression, filmischer Aufbau.' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: 'Direkt, schnell, kompromisslos.' }],
      fieldsH: 'In die Anfrage aufnehmen',
      fields: ['Projekttyp', 'Nutzung', 'Territorium', 'Laufzeit', 'Budgetrahmen', 'Deadline', 'Kontakt'],
      emailCta: 'Sync-Anfrage senden ↗',
      note: 'Bedingungen werden im Einzelfall vereinbart. Keine pauschalen Rechteansprüche — an manchen Arbeiten halten Dritte Rechte.',
      navLabel: 'Sync',
    },
  },
  es: {
    ...
    usePage: {
      title: 'Usar la música de HXI — creadores / info NCS',
      description: 'Cómo usar la música de HXI en tu contenido: lanzamientos NCS y condiciones por pista.',
      eyebrow: 'USO PARA CREADORES',
      heading: 'Usa la música de HXI.',
      lead: 'Respuesta corta: algunas pistas de HXI están autorizadas para contenido de creadores. Las condiciones dependen de cada pista.',
      noteH: 'IMPORTANTE',
      note: 'Las condiciones son por pista. Los lanzamientos NCS siguen las condiciones de NCS. Las demás pistas tienen condiciones aparte. No asumas permiso general — revisa la pista antes de publicar.',
      ncsH: 'Lanzamientos NCS',
      ncsP: 'Las pistas publicadas a través de NCS pueden usarse en vídeos de YouTube, TikTok, streams y otros contenidos en línea bajo las condiciones vigentes de NCS.',
      checkTerms: 'Ver condiciones de la pista ↗',
      proH: 'Uso profesional / comercial',
      proP: 'Cine, TV, publicidad y videojuegos no entran en las condiciones de creadores. El uso de creador no es una licencia — usa la vía de sync.',
      syncCta: 'Sync / licencias →',
      navLabel: 'Uso creador',
    },
    syncPage: {
      title: 'HXI Sync y licencias',
      description: 'Música de HXI para cine, TV, videojuegos y publicidad. Solicitudes profesionales de sync y licencias.',
      eyebrow: 'SYNC / LICENCIAS',
      heading: 'Música para la imagen.',
      lead: 'Contacto directo, sin intermediarios. Para cine, videojuegos, publicidad y medios.',
      worksH: 'OBRAS LISTAS PARA SYNC',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: 'Alta energía, phonk distorsionado. Crédito de remix documentado.' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: 'Agresión controlada, construcción cinematográfica.' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: 'Directo, rápido, sin concesiones.' }],
      fieldsH: 'Incluye en tu solicitud',
      fields: ['Tipo de proyecto', 'Uso', 'Territorio', 'Plazo', 'Rango de presupuesto', 'Fecha límite', 'Contacto'],
      emailCta: 'Enviar solicitud de sync ↗',
      note: 'Las condiciones se acuerdan caso por caso. Sin reclamaciones generales de derechos — algunas obras tienen titulares de derechos terceros.',
      navLabel: 'Sync',
    },
  },
  pt: {
    ...
    usePage: {
      title: 'Usar a música do HXI — criadores / informação NCS',
      description: 'Como usar a música do HXI no teu conteúdo: lançamentos NCS e condições por faixa.',
      eyebrow: 'USO PARA CRIADORES',
      heading: 'Usa a música do HXI.',
      lead: 'Resposta curta: algumas faixas do HXI estão liberadas para conteúdo de criadores. As condições são por faixa.',
      noteH: 'IMPORTANTE',
      note: 'As condições são por faixa. Os lançamentos NCS seguem as condições da NCS. As outras faixas têm condições próprias. Não assumas permissão geral — verifica a faixa antes de publicar.',
      ncsH: 'Lançamentos NCS',
      ncsP: 'As faixas lançadas pela NCS podem ser usadas em vídeos do YouTube, TikTok, streams e outros conteúdos online sob as condições atuais da NCS.',
      checkTerms: 'Ver condições da faixa ↗',
      proH: 'Uso profissional / comercial',
      proP: 'Cinema, TV, publicidade e jogos não entram nas condições de criador. Uso de criador não é licença — usa a via de sync.',
      syncCta: 'Sync / licenciamento →',
      navLabel: 'Uso de criador',
    },
    syncPage: {
      title: 'HXI Sync e licenciamento',
      description: 'Música do HXI para cinema, TV, jogos e publicidade. Pedidos profissionais de sync e licenciamento.',
      eyebrow: 'SYNC / LICENCIAMENTO',
      heading: 'Música para a imagem.',
      lead: 'Contacto direto, sem intermediários. Para cinema, jogos, publicidade e média.',
      worksH: 'OBRAS PRONTAS PARA SYNC',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: 'Alta energia, phonk distorcido. Crédito de remix documentado.' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: 'Agressão controlada, construção cinematográfica.' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: 'Direto, rápido, sem concessões.' }],
      fieldsH: 'Inclui no teu pedido',
      fields: ['Tipo de projeto', 'Uso', 'Território', 'Prazo', 'Faixa de orçamento', 'Data limite', 'Contacto'],
      emailCta: 'Enviar pedido de sync ↗',
      note: 'As condições são acordadas caso a caso. Sem reivindicações gerais de direitos — algumas obras têm titulares de direitos terceiros.',
      navLabel: 'Sync',
    },
  },
  ar: {
    ...
    usePage: {
      title: 'استخدام موسيقى HXI — للمبدعين / معلومات NCS',
      description: 'كيف تستخدم موسيقى HXI في محتواك: إصدارات NCS وشروط خاصة بكل مقطوعة.',
      eyebrow: 'استخدام المبدعين',
      heading: 'استخدم موسيقى HXI.',
      lead: 'الجواب المختصر: بعض مقطوعات HXI متاحة لمحتوى المبدعين. الشروط تخص كل مقطوعة على حدة.',
      noteH: 'مهم',
      note: 'الشروط خاصة بكل مقطوعة. إصدارات NCS تتبع شروط NCS. المقطوعات الأخرى لها شروط منفصلة. لا تفترض إذنًا عامًا — تحقق من المقطوعة قبل النشر.',
      ncsH: 'إصدارات NCS',
      ncsP: 'المقطوعات الصادرة عبر NCS يمكن استخدامها في فيديوهات يوتيوب وتيك توك والبث وغيرها من المحتوى الرقمي وفق شروط NCS الحالية.',
      checkTerms: 'اطّلع على شروط المقطوعة ↗',
      proH: 'الاستخدام المهني / التجاري',
      proP: 'الأفلام والتلفزيون والإعلانات والألعاب لا تدخل ضمن شروط المبدعين. استخدام المبدعين ليس ترخيص ملكية — استخدم مسار الـ sync.',
      syncCta: 'Sync / الترخيص',
      navLabel: 'استخدام المبدعين',
    },
    syncPage: {
      title: 'HXI — المزامنة والترخيص',
      description: 'موسيقى HXI للأفلام والتلفزيون والألعاب والإعلانات. طلبات مهنية للمزامنة والترخيص.',
      eyebrow: 'المزامنة / الترخيص',
      heading: 'موسيقى للصورة.',
      lead: 'تواصل مباشر دون وسطاء. للأفلام والألعاب والإعلانات والإعلام.',
      worksH: 'أعمال جاهزة للمزامنة',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: 'طاقة عالية وفونك مشوَّه. اعتماد ريمكس موثَّق.' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: 'عدوانية منضبطة وبناء سينمائي.' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: 'مباشر وسريع وبلا مساومة.' }],
      fieldsH: 'أدرج في طلبك',
      fields: ['نوع المشروع', 'الاستخدام', 'النطاق الجغرافي', 'المدة', 'نطاق الميزانية', 'الموعد النهائي', 'جهة الاتصال'],
      emailCta: 'أرسل طلب مزامنة ↗',
      note: 'تُتفق الشروط حالة بحالة. لا ادعاءات حقوق عامة — بعض الأعمال فيها أصحاب حقوق آخرون.',
      navLabel: 'Sync',
    },
  },
  ja: {
    ...
    usePage: {
      title: 'HXIの楽曲を使う — クリエイター / NCS情報',
      description: 'コンテンツでHXIの楽曲を使う方法:NCSリリースとトラックごとの条件。',
      eyebrow: 'クリエイター利用',
      heading: 'HXIの楽曲を使う。',
      lead: '結論:一部のHXIトラックはクリエイターコンテンツで利用できます。条件はトラックごとに異なります。',
      noteH: '重要',
      note: '条件はトラックごとです。NCSリリースはNCSの条件に従います。その他のトラックは別条件です。包括的な許可を前提にせず、公開前にトラックを確認してください。',
      ncsH: 'NCSリリース',
      ncsP: 'NCS経由のトラックは、現行のNCS条件のもとでYouTube動画、TikTok、配信などのオンラインコンテンツで利用できます。',
      checkTerms: 'トラックの条件を確認 ↗',
      proH: 'プロフェッショナル / 商用利用',
      proP: '映画、TV、広告、ゲームへの使用はクリエイター条件の対象外です。クリエイター利用はライセンス保有ではありません。syncの窓口をご利用ください。',
      syncCta: 'Sync / ライセンス →',
      navLabel: 'クリエイター利用',
    },
    syncPage: {
      title: 'HXI Sync・ライセンス',
      description: '映画、TV、ゲーム、広告のためのHXIの音楽。プロ向けのsync・ライセンス問い合わせ。',
      eyebrow: 'SYNC / ライセンス',
      heading: '映像のための音楽。',
      lead: '仲介なしの直接連絡。映画、ゲーム、広告、メディア用途に。',
      worksH: 'SYNC向きの作品',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: '高エネルギー、歪んだphonk。記録されたリミックスクレジット。' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: '制御されたアグレッション、映画的なビルド。' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: 'ダイレクトで速く、妥協なし。' }],
      fieldsH: '問い合わせに含める項目',
      fields: ['プロジェクト種別', '用途', '地域', '期間', '予算帯', '締切', '連絡先'],
      emailCta: 'Sync問い合わせを送る ↗',
      note: '条件は案件ごとに合意します。包括的な権利主張はしません。第三者が権利を持つ作品もあります。',
      navLabel: 'Sync',
    },
  },
  zh: {
    ...
    usePage: {
      title: '使用 HXI 音乐 — 创作者 / NCS 信息',
      description: '如何在你的内容中使用 HXI 音乐:NCS 发行与按曲目划分的条款。',
      eyebrow: '创作者使用',
      heading: '使用 HXI 音乐。',
      lead: '简短回答:部分 HXI 曲目可用于创作者内容。条款按曲目划分。',
      noteH: '重要',
      note: '条款按曲目划分。NCS 发行遵循 NCS 条款,其他曲目另有条款。不要假设有整体授权 — 发布前请核对具体曲目。',
      ncsH: 'NCS 发行',
      ncsP: '通过 NCS 发行的曲目,可在现行 NCS 条款下用于 YouTube 视频、TikTok、直播及其他线上内容。',
      checkTerms: '查看曲目条款 ↗',
      proH: '专业 / 商业使用',
      proP: '电影、电视、广告和游戏植入不适用创作者条款。创作者使用不等于许可权 — 请走 sync 渠道。',
      syncCta: 'Sync / 授权 →',
      navLabel: '创作者使用',
    },
    syncPage: {
      title: 'HXI Sync 与授权',
      description: '用于电影、电视、游戏和广告的 HXI 音乐。专业 sync 与授权咨询。',
      eyebrow: 'SYNC / 授权',
      heading: '为影像而作的音乐。',
      lead: '直接联系,无中间环节。适用于电影、游戏、广告和媒体。',
      worksH: '适合 SYNC 的作品',
      works: [{ t: 'WORTH NOTHING', meta: '2024 · REMIX', c: '高能量、失真 phonk。有记录的混音署名。' }, { t: 'Never Phased', meta: '2024 · BODYCAM OST', c: '克制的攻击性、电影感的推进。' }, { t: 'Lock n’ Load', meta: '2024 · NCS', c: '直接、快速、毫不妥协。' }],
      fieldsH: '咨询时请附上',
      fields: ['项目类型', '用途', '地区', '期限', '预算范围', '截止时间', '联系方式'],
      emailCta: '发送 sync 咨询 ↗',
      note: '条款逐案商定。不作整体权利主张 — 部分作品涉及第三方权利人。',
      navLabel: 'Sync',
    },
  },
};